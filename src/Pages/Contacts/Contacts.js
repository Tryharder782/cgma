      ...
      <div className='pageWrapper'>
         <div className="pageContainer">
            ...
            <div className="contact-info">
               <div>
                  <strong>Email:</strong> <a href="mailto:semetei.arkabaev@gmail.com">semetei.arkabaev@gmail.com</a>
               </div>
               <div>
                  <strong>Telegram:</strong> <a href="https://t.me/Boevayasemga" target="_blank" rel="noreferrer">@Boevayasemga</a>
               </div>
            </div>
